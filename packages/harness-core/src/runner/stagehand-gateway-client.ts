...
import { buildGatewayUsageRecord, createGatewayLanguageModel } from "../ai/gateway.js";
...
export interface StagehandGatewayTrackingClientOptions {
  modelId: string;
  provider: string;
  phase: AiUsagePhase;
...
export class StagehandGatewayTrackingClient extends LLMClient {
  ...
  constructor(options: StagehandGatewayTrackingClientOptions) {
    ...
    this.model = createGatewayLanguageModel(options.modelId, this.env);
  }
