...
import { buildBenchmarkReport } from "../../src/reporting/report.js";
import type { Finding, ModelRunSummary } from "../../src/types.js";

describe("report snapshot", () => {
  it("builds a stable benchmark report shape", () => {
    ...
    const findings: Finding[] = [
      {
        ...
        sourceCandidates: [
          {
            path: "/tmp/workspace/public/modules/ui/render.js",
            workspaceRelativePath: "public/modules/ui/render.js",
            score: 30,
            reasons: ["locator failures usually come from missing or changed markup"]
          }
        ],
